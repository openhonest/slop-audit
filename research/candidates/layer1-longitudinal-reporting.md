...
**Status: candidate.** The method behind this is `layer1-longitudinal-method.md` and is not approved. Would become section 6a of `../../spec/06-slop-report-template.md`. Covers only what a business reader sees.
