...
def scan(repo: Path, lang: str) -> dict:
    ...
    # this module returned "no hardcoded machine-specific absolute paths" for both until the
    # 2026-08-16 sweep. vacuity.py had already named this module as an instance; secret_scan
    # and thread_surface were repaired at the time and this one was missed.
    if not files:
