...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Lines of code flagged as unreachable or unreferenced by a language-appropriate dead-code analyzer (<code>vulture</code> for Python, <code>ts-prune</code>/<code>knip</code> for TypeScript, <code>staticcheck</code>/<code>unused</code> for Go, IntelliJ inspections or <code>error-prone</code> for Java, <code>dead_code</code> lints for Rust, RuboCop dead-code cops for Ruby), divided by total production lines of code</td>
      <td>&lt;1%</td>
      <td>1–5%</td>
      <td>&gt;5%</td>
    </tr>
    ...
    <tr>
      ...
      <td>Percentage of production LOC participating in a Type-2 or Type-3 clone class of ≥50 tokens, measured by a fuzzy clone detector with identifier and literal normalization. Reference tool: <code>pmd cpd --ignore-identifiers --ignore-literals --minimum-tokens 50</code>. Alternatives: <code>jscpd</code> with <code>mode: "weak"</code>, NiCad or SourcererCC for deeper Type-3 analysis.</td>
      <td>&lt;3%</td>
      <td>3–10%</td>
      <td>&gt;10%</td>
    </tr>
    ...
    <tr>
      ...
      <td>Number of secrets detected by <code>gitleaks detect --no-git</code> (or <code>trufflehog filesystem .</code>, or <code>detect-secrets scan</code>) run against the current tree with the default ruleset. In a regulated enterprise any non-zero count is disqualifying.</td>
      <td>0</td>
